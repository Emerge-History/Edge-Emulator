...
function _method_shell(funcName, args) {
    console.log("invoke", funcName, args);
}

function _event_handler(api_endpoint, event_id, paramArray) {
...
module.exports.EventHandler = _event_handler;
